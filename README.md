...
1. **[Аутентификация](docs/api/authentication.md)** - Как авторизоваться в API

### 📋 Методы API

#### Управление данными
- **[Валидация аккаунта](docs/api/validateAccount.md)** - Проверка доступа к аккаунту
- **[Получение списка кампаний](docs/api/getCampaignsList.md)** - Список рекламных кампаний
- **[Получение списка групп объявлений](docs/api/getGroupsList.md)** - Группы объявлений в кампаниях

#### Настройки и стратегии
- **[Получение стратегий кампаний](docs/api/getCampaignStrategies.md)** - Настройки стратегий и бюджетов

#### Статистика
- **[Получение статистики кампаний](docs/api/getCampaignsStatistics.md)** - Статистика по кампаниям с метриками
- **[Получение статистики групп объявлений](docs/api/getGroupsStatistics.md)** - Статистика по группам объявлений
- **[Получение статистики аккаунта](docs/api/getAccountStatistics.md)** - Статистика по всему аккаунту с группировкой

#### Асинхронные процессы
- **[Асинхронные процессы](docs/api/asyncProcesses.md)** - Запуск и управление фоновыми операциями
...
- **[Коды ошибок](docs/api/errors.md)** - Описание ошибок и способы их исправления
...
Для вопросов и проблем обратитесь в службу поддержки или проверьте раздел [Коды ошибок](docs/api/errors.md).
